...
class VelocityTriangles(Screen):
    ...
    def systemsolver(self):
        ...
        sys = sy.nsolve((a1e + 57.2955*(sy.atan(-((float(pe) / 2) - 1 + float(rne)) / float(fe))),
            a2e- 57.2955*(sy.atan(((float(pe) / 2)+1-float(rne)) / float(fe))),
            b1e - 57.2955*(sy.atan(((float(pe) / 2) + float(rne)) / float(fe))),
            b2e + 57.2955*(sy.atan(-((float(pe) / 2) - float(rne)) / float(fe)))),X,(1,1,1,1))

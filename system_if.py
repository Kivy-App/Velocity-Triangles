...
if  X == [2,3,6,7]:               #p,a1,a2
	...
	b1e = np.degrees(np.arctan((pe*np.tan(a1) + np.tan(a1) + np.tan(a2))/pe))
	b2e = np.degrees(np.arctan((-np.tan(a1) + pe*np.tan(a2) - np.tan(a2))/pe))

if  X == [2,3,5,7]:               #p,a1,b1
	rne = (pe*np.tan(a1) - pe*np.tan(b1) + 2*np.tan(b1))/(2*(np.tan(b1) - np.tan(a1)))
	fe = 1/(np.tan(b1) - np.tan(a1))
	a2e = -np.degrees(np.arctan((pe*np.tan(a1) + np.tan(a1) - pe*np.tan(b1))))
	b2e = -np.degrees(np.arctan((pe*np.tan(a1) - pe*np.tan(b1) + np.tan(b1))))
...
if  X == [2,3,4,6]:               #p,a2,b2
	...
	a1e = -np.degrees(np.arctan(-pe*np.tan(a2) + np.tan(a2) + pe*np.tan(b2)))
	b1e = np.degrees(np.arctan(pe*np.tan(a2) - pe*np.tan(b2) - np.tan(b2)))

if  X == [2,3,4,5]:               #p,b1,b2
	fe = pe/(np.tan(b1) + np.tan(b2))
	rne = (-pe/2)*((np.tan(b2)-np.tan(b1))/(2*(np.tan(b1) + np.tan(b2))))
	a1e = np.degrees(np.arctan((pe*np.tan(b1) - np.tan(b1) - np.tan(b2))/pe))
	a2e = np.degrees(np.arctan((np.tan(b1) + pe*np.tan(b2) + np.tan(b2))/pe))
...
if  X == [1,3,6,7]:               #f,a1,a2
	...
	b1e = np.degrees(np.arctan(np.tan(a1) + 1/fe))
	b2e = np.degrees(np.arctan(np.tan(a2) - 1/fe))
...
if  X == [1,2,5,7]:               #r,a1,b1
	...
	fe = 1/(np.tan(b1) - np.tan(a1))
	a2e = -np.degrees(np.arctan(-2*rne*np.tan(a1) + np.tan(a1) + 2*rne*np.tan(b1) - 2*np.tan(b1)))
	b2e = np.degrees(np.arctan(2*rne*np.tan(a1) - 2*rne*np.tan(b1) + np.tan(b1)))
